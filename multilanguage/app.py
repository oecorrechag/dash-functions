...
from utils.layouts import header, header2
...
# Callback para el header indicado
...
# Callback para guardar la eleccion de idioma
@callback(
...
# Callback para mostrar la pagina seleccionada
